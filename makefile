...
#    Updated: 2022/07/06 03:55:58 by mbenbajj         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
EXEC_SRC = execution/utils/proccess_buffer.c execution/utils/ft_check.c execution/utils/ft_utils.c \
			execution/utils/ft_errors.c execution/utils/analyse_exec.c execution/utils/execute_cmd.c execution/utils/execution_func.c\
